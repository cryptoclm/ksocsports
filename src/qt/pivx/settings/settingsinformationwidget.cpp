...
SettingsInformationWidget::SettingsInformationWidget(KICKSOCCERGUI* _window,QWidget *parent) :
    ...
    ui(new Ui::SettingsInformationWidget)
{
    ...
    connect(ui->pushButtonFile, &QPushButton::clicked, [this](){
        if (!GUIUtil::openConfigfile())
            inform(tr("Unable to open kicksoccer.conf with default application"));
    });
