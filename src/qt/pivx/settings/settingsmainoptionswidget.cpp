...
SettingsMainOptionsWidget::SettingsMainOptionsWidget(KICKSOCCERGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsMainOptionsWidget)
{
    ...
    // Switch
    ui->pushSwitchStart->setText(tr("Start KICKSOCCER on system login"));
