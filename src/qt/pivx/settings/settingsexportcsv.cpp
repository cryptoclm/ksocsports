...
SettingsExportCSV::SettingsExportCSV(KICKSOCCERGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("KICKSOCCER_tx_csv_export(*.csv)") : tr("KICKSOCCER_addresses_csv_export(*.csv)"),
                                        nullptr);
