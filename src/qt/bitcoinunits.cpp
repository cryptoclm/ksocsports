...
QString BitcoinUnits::id(int unit)
{
    ...
    case PIV:
        return QString("chnd");
    case mPIV:
        return QString("mchnd");
    case uPIV:
        return QString::fromUtf8("uchnd");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case PIV:
            return QString("KSOC");
        case mPIV:
            return QString("mKSOC");
        case uPIV:
            return QString::fromUtf8("μKSOC");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case PIV:
            return QString("tKSOC");
        case mPIV:
            return QString("mtKSOC");
        case uPIV:
            return QString::fromUtf8("μtKSOC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case PIV:
            return QString("KSOC");
        case mPIV:
            return QString("Milli-KSOC (1 / 1" THIN_SP_UTF8 "000)");
        case uPIV:
            return QString("Micro-KSOC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case PIV:
            return QString("TestKSOC");
        case mPIV:
            return QString("Milli-TestKSOC (1 / 1" THIN_SP_UTF8 "000)");
        case uPIV:
            return QString("Micro-TestKSOC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
