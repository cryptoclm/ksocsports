...
/* KICKSOCCER GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "KickSoccerv2"
#define QAPP_ORG_DOMAIN "kicksoccerv2.io"
#define QAPP_APP_NAME_DEFAULT "KickSoccerv2-Qt"
#define QAPP_APP_NAME_TESTNET "KickSoccerv2-Qt-testnet"
