...
/** Utility functions used by the KICKSOCCER Qt UI.
 */
namespace GUIUtil
{
...
// Render KICKSOCCER addresses in monospace font
...
// Parse "kicksoccer:" URI into recipient object, return true on successful parsing
