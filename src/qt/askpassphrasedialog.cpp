...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                " <b>" + tr("LOSE ALL OF YOUR KSOC") + "</b>!<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            newpassCache = newpass1;
            KICKSOCCERGUI* window = static_cast<KICKSOCCERGUI*>(parentWidget());
...
{
    KICKSOCCERGUI* gui = static_cast<KICKSOCCERGUI*>(parentWidget());
...
{
    hide();
    static_cast<KICKSOCCERGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("KICKSOCCER will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your KSOC from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
