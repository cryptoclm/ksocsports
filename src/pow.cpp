...
{
    /* current difficulty formula, kicksoccer - DarkGravity v3, written by Evan Duffield - evan@dashpay.io */
...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader* pblock)
{
	...
	if (BlockLast->nHeight <= 57600){ //initial reward about 2021/01/25
