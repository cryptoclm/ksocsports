...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("KICKSOCCER Core kicksoccer-tx utility version") + " " + FormatFullVersionWithCodename() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  kicksoccer-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kicksoccer transaction") + "\n" +
                               "  kicksoccer-tx [options] -create [commands]   " + _("Create hex-encoded kicksoccer transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kicksoccer transaction
