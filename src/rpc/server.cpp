...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop KICKSOCCER server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "KICKSOCCER server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* KICKSOCCER features */
        {"kicksoccer", "listmasternodes", &listmasternodes, true, true, false},
        {"kicksoccer", "getmasternodecount", &getmasternodecount, true, true, false},
        {"kicksoccer", "masternodeconnect", &masternodeconnect, true, true, false},
        {"kicksoccer", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"kicksoccer", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"kicksoccer", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"kicksoccer", "masternodecurrent", &masternodecurrent, true, true, false},
        {"kicksoccer", "masternodedebug", &masternodedebug, true, true, false},
        {"kicksoccer", "startmasternode", &startmasternode, true, true, false},
        {"kicksoccer", "createmasternodekey", &createmasternodekey, true, true, false},
        {"kicksoccer", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"kicksoccer", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"kicksoccer", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"kicksoccer", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"kicksoccer", "getmasternodescores", &getmasternodescores, true, true, false},
        {"kicksoccer", "preparebudget", &preparebudget, true, true, false},
        {"kicksoccer", "submitbudget", &submitbudget, true, true, false},
        {"kicksoccer", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"kicksoccer", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"kicksoccer", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"kicksoccer", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"kicksoccer", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"kicksoccer", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"kicksoccer", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"kicksoccer", "checkbudgets", &checkbudgets, true, true, false},
        {"kicksoccer", "mnsync", &mnsync, true, true, false},
        {"kicksoccer", "spork", &spork, true, true, false},
        {"kicksoccer", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> kicksoccer-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:20554/\n";
}
