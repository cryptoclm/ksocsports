...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_5_MAX_VALUE,                       1000),          // 1000 KICKSOCCER
    ...
    MAKE_SPORK_DEF(SPORK_15_NEW_PROTOCOL_ENFORCEMENT_2,     1618529400),    // Thu Apr 15 2021 23:30:00 GMT+0000
    MAKE_SPORK_DEF(SPORK_17_COLDSTAKING_ENFORCEMENT,        1598626800),    // ON 08/28/2020 @ 3:00pm (UTC)
    MAKE_SPORK_DEF(SPORK_20_FORCE_ENABLED_MASTERNODE,       0), // ON
};
...
// KICKSOCCER: on startup load spork values from previous session if they exist in the sporkDB
...
void CSporkManager::ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "spork") {
        ...
        // KICKSOCCER: add to spork database.
