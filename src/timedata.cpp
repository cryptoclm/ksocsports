...
void AddTimeData(const CNetAddr& ip, int64_t nOffsetSample, int nOffsetLimit)
{
	...
	if (abs64(nMedian) <= nMaxTimeAdjustment) {
            ...
            //std::string strMessage = _("Warning: Please check that your computer's date and time are correct! If your clock is wrong KICKSOCCER Core will not work properly.");
